...
% otherwise render a simple labelled placeholder so the document always compiles.
% Takes ONE argument: the base filename (no extension). The caption is handled
% by \caption{} in the surrounding figure environment.
\newcommand{\aximfig}[1]{%
  \IfFileExists{#1.png}{\includegraphics[width=0.8\textwidth]{#1.png}}{%
  \IfFileExists{docs/assets/#1.png}{\includegraphics[width=0.8\textwidth]{docs/assets/#1.png}}{%
  \fbox{\parbox{0.7\textwidth}{\centering\vspace{1em}\texttt{[#1.png not found --- run scripts/make\_bench\_charts.py or upload the PNG]}\vspace{1em}}}}}%
}

...
% graphicspath above handles path lookup; just use \includegraphics directly.
% Upload the PNGs to the Overleaf project root or docs/assets/.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{axim_throughput.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{axim_latency.png}

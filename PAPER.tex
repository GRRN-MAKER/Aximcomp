...
\texttt{silu}, \texttt{rmsnorm}, \texttt{swiglu}. The single remaining limitation is thus
\emph{empirical}---cross-vendor GPU numbers must be measured on NVIDIA/AMD/Intel silicon;
the implementation is in place and compiles.
